        ...
        <>
            <main>
                ...
                <section id='help' class='container max-h-full mx-auto my-3'>
                    <div class='flex flex-wrap md:flex lg:grid lg:grid-cols-8 px-4 mx-auto pb-2 mb-6'>
                        <div class='col-span-1'>
                            <Link
                                to={'/overview'}
                                class='mb-6 text-sm hover:underline'
                            >
                                &#8592; Return
                            </Link>
                        </div>
                        <div class='col-span-4'>
                            <h2 class='mb-3 mt-10 lg:mt-0 text-md font-bold text-gray-900 dark:text-white'>
                                Size guide
                            </h2>
                            <div class='relative w-3/4 lg:w-full overflow-x-auto mb-12'>
                                <table
                                    id='table-guide-size'
                                    class='w-full text-sm text-left text-gray-500 dark:text-gray-400'
                                >
                                    <thead class='text-xs border-b border-slate-300 text-gray-900 uppercase dark:text-gray-400'>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr class='bg-white dark:bg-gray-800 border-b border-slate-300'>
                                            <th
                                                scope='row'
