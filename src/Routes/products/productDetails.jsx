...
export const ProductDetailRoute = () => {
    return (
        <>
            <main
                class="container w-screen mx-0 max-h-full min-h-full min-w-full mb-10"
            >
                <div class="grid grid-cols-1 md:gap-4 md:grid-cols-3">
                    <div class="col-span-2">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            <div
                                class="group overflow-hidden hover:scale-95 transition duration-500 ease-in-out"
                            >
                                <img
                    ...
                    <div class="col-span-1">
                        <div class="m-0.5 md:m-10">
                            <h2 class="font-bold text-slate-900 text-xl">Produk Name</h2>
                            ...
                            <div class="flex items-center justify-center py-2">
                                <button
                                    class="bg-slate-900 w-full py-3 text-white font-bold text-base hover:opacity-75"
                                >
                                    Add to bag
                                </button>
                            </div>
                            ...
                            <div class="mt-2">
                                <h2 class="font-medium text-lg text-slate-800">Description</h2>
