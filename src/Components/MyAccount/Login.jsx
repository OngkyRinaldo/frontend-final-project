            ...
            <section className='container mx-auto'>
                <div className='container h-auto px-3 py-4 flex flex-col sm:flex-row mt-8'>
                    ...
                    <div className='lg:w-3/4 sm:w-3/4 md:w-3/4 pb-3'>
                        <h2 className='text-xl font-semibold pb-1 md:pb-5 lg:pb-5'>
                            Login
                        </h2>
                        <form className='grid grid-cols-1 gap-2 md:grid-cols-1 lg:grid-cols-1 md:gap-4 lg:gap-6 mt-3 md:mt-10 lg:mt-10'>
                            <div className='mb-6'>
                                <label
                                    htmlFor='email'
                            ...
                            <div className='md:flex-row lg:flex-row md:flex justify-start md:justify-between mb-6 sm:grid sm:grid-cols-1 sm:gap-1'>
                                ...
                                <div className='md:mt-0 lg:md-0 mt-3'>
                                    <button
                                        type='submit'
                                        className='rounded-lg text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-600 font-normal text-sm px-5 py-2.5 lg:px-16 md:px-12 text-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800 float-left'
                                    >
                                        Sign in
                                    </button>
                                </div>
