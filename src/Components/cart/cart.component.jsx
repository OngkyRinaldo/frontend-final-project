            ...
            <div className="grid grid-cols-1 lg:grid-cols-4">
                <div className="col-span-1">
                    <div className="px-4 mx-auto pb-2 mb-2 lg:mb-6">
                        <Link to={"/"} className="lg:mb-6 text-base hover:underline"
                        >&#8592; Keep shopping</Link >
                    </div>
                </div>
                <div className="col-span-3">
                    <div className="relative overflow-x-auto  mb-12">
                            ...
                            <tbody className="text-slate-800">
                                ...
                                >
                                    ...
                                    <td className="px-0 py-2 md:py-4">
                                        ...
                                        <select name="qty" id="qty" className="border-slate-200 rounded-lg">
                                            {Array.from({ length: 100 }, (_, i) => (
                                                <option key={i + 1} value={i + 1}>
                                                    {i + 1}
                                                </option>
                        ...
                        <div
                            className="flex items-center justify-between md:justify-end  my-4"
                        >
                        ...
                        <div className="flex items-center border-b  border-slate-300 pb-5 justify-center md:justify-end">
                            <Link
                                to={"/shipping"}
                                className="bg-slate-900 text-white rounded-lg font-semibold text-base text-center py-3 w-full md:w-1/3 md:px-28 hover:opacity-75"
                            >Checkout</Link   >
                        </div>
                    </div>
                </div>
